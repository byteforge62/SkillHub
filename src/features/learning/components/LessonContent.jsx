          ...
          switch (block.type) {
            ...
            case "code":
              return (
                <div
                  key={block._id}
                  className="lg:col-span-5 overflow-hidden rounded-xl border border-border bg-surface-hover"                >
            ...
            case "callout":
              return (
                <div
                  key={block._id}
                  className="lg:col-span-7 rounded-xl border border-primary/20 bg-primary/5 p-5"                >
                  {block.data?.title && (
            ...
            case "resource": {
              ...
              return (
                <div
                  key={block._id}
                  className="lg:col-span-5 rounded-xl border border-border bg-surface p-5"                >
